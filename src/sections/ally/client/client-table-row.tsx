    ...
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>
            <Label
              variant="soft"
              color={row.isPotentialInvestor ? 'success' : 'error'}
            >
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>
          <Label
            variant="soft"
            color={row.allowyounger === 'Si' ? 'success' : row.allowyounger === 'No' ? 'error' : 'default'}
          >
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>
          <Label
                variant="soft"
                color={row.allowpets === 'Si' ? 'success' : row.allowpets === 'No' ? 'error' : 'default'}
              >
