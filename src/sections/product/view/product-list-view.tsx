...
export function ProductListView() {
  ...
  const { clients: products, clientsLoading: productsLoading } = useGetClients();

  const [tableData, setTableData] = useState<IProductItem[]>(products as any);
  ...
  const columns: GridColDef[] = [
    { field: 'category', headerName: 'Category', filterable: false },
    {
      ...
      filterable: false,
      renderCell: (params) => (
        <RenderCellProduct params={params} href={paths.dashboard.clients.details(params.row.id)} />
      ),
    },
    {
      field: 'createdAt',
      ...
      <DashboardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Product', href: paths.dashboard.clients.root },
            { name: 'List' },
          ]}
          action={
            <Button
